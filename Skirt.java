...
public class Skirt extends Bottom{
	...
	public Skirt(int legsLength, int waist, int hips, int length) {
		super(legsLength, waist, hips, length);
		// TODO Auto-generated constructor stub
	}

	public Skirt(String name, int id, String material, String colour, String pattern, int size, int amount,
	...
	public String toStringShort() {
		return "Skirt " + this.getName();
	}

	@Override
	public String toString() {
		return "Skirt [name= " + getName() + ", id= " + getId() + ", material= " + getMaterial() 
